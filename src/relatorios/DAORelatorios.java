...
public class DAORelatorios extends ConexaoMySql{
    ...
    public boolean gerarRelatorioCliente() {
        try {
            ...
            String nomeArquivo = "C://BLVendasPdvMySQL//Relatorios//RelatorioCliente.pdf";
    ...
    public boolean gerarRelatorioProdutos() {
        try {
            ...
            String nomeArquivo = "C://BLVendasPdvMySQL//Relatorios//RelatorioProduto.pdf";
            JasperExportManager.exportReportToPdfFile(jasperPrint, nomeArquivo);
            File file = new File(nomeArquivo);
            try {
                Desktop.getDesktop().open(file);
    ...
    public boolean gerarRelatorioFornecedores() {
        try {
            ...
            String nomeArquivo = "C://BLVendasPdvMySQL//Relatorios//RelatorioFornecedor.pdf";
            JasperExportManager.exportReportToPdfFile(jasperPrint, nomeArquivo);
            File file = new File(nomeArquivo);
            try {
                Desktop.getDesktop().open(file);
    ...
    public boolean gerarRelatorioVenda(int pCodigo) {
        try {
            ...
            String nomeArquivo = "C://BLVendasPdvMySQL//Relatorios//RelatorioVenda.pdf";
            JasperExportManager.exportReportToPdfFile(jasperPrint, nomeArquivo);
            File file = new File(nomeArquivo);
            try {
                Desktop.getDesktop().open(file);
    ...
    public boolean gerarRelatorioPDV(int pCodigo) {
        try {
            ...
            String nomeArquivo = "C://BLVendasPdvMySQL//Relatorios//RelatorioPDV.pdf";
            JasperExportManager.exportReportToPdfFile(jasperPrint, nomeArquivo);
            File file = new File(nomeArquivo);
            try {
                Desktop.getDesktop().open(file);
    ...
    public boolean gerarRelatorioContaReceber(int pCodigo) {
        try {
            ...
            String nomeArquivo = "C://BLVendasPdvMySQL//Relatorios//ContaReceber.pdf";
            JasperExportManager.exportReportToPdfFile(jasperPrint, nomeArquivo);
            File file = new File(nomeArquivo);
            try {
                Desktop.getDesktop().open(file);
    ...
    public boolean gerarRelatorioContaPagar(int pCodigo) {
        try {
            ...
            String nomeArquivo = "C://BLVendasPdvMySQL//Relatorios//ContaPagar.pdf";
            JasperExportManager.exportReportToPdfFile(jasperPrint, nomeArquivo);
            File file = new File(nomeArquivo);
            try {
                Desktop.getDesktop().open(file);
    ...
    public boolean gerarRelatorioVendaData(Date pData) {
        try {
            ...
            String nomeArquivo = "C://BLVendasPdvMySQL//Relatorios//VendaData.pdf";
            JasperExportManager.exportReportToPdfFile(jasperPrint, nomeArquivo);
            File file = new File(nomeArquivo);
            try {
                Desktop.getDesktop().open(file);
    ...
    public boolean gerarRelatorioVendaCliente(String pCliente) {
        try {
            ...
            String nomeArquivo = "C://BLVendasPdvMySQL//Relatorios//VendaCliente.pdf";
            JasperExportManager.exportReportToPdfFile(jasperPrint, nomeArquivo);
            File file = new File(nomeArquivo);
            try {
                Desktop.getDesktop().open(file);
