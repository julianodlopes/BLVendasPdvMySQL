...
public class ViewPdv extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jtfQuantidade = new util.VerificarCampo("Numeros",15);
        jtfCodigoProduto = new util.VerificarCampo("Numeros",15);
        ...
        jmiAdicionarProduto = new javax.swing.JMenuItem();
        ...
        setTitle("Mais ativos");

        jPanel1.setBackground(new java.awt.Color(204, 204, 204));
        jPanel1.setLayout(new org.netbeans.lib.awtextra.AbsoluteLayout());

        jLabelImagem.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagens/fundo.jpg"))); // NOI18N
        jPanel1.add(jLabelImagem, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 840, 120));
        ...
        jTextFieldStatusCaixa.setFont(new java.awt.Font("Tahoma", 0, 24)); // NOI18N
        jTextFieldStatusCaixa.setHorizontalAlignment(javax.swing.JTextField.CENTER);
        jTextFieldStatusCaixa.setText("Caixa aberto");
        ...
        jLabel5.setText("F3 - Adicionar produto");
        ...
        jPanel2Layout.setHorizontalGroup(
            ...
            .addComponent(jTextFieldStatusCaixa)
        ...
        jtfCodigoProduto.setFont(new java.awt.Font("Tahoma", 0, 18)); // NOI18N
        ...
        jmiAdicionarProduto.setAccelerator(javax.swing.KeyStroke.getKeyStroke(java.awt.event.KeyEvent.VK_F3, 0));
        jmiAdicionarProduto.setText("Adicionar produto");
        jmiAdicionarProduto.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                jmiAdicionarProdutoActionPerformed(evt);
            }
        });
        jmComandos.add(jmiAdicionarProduto);
        ...
        jmiAlterarQuantidade.setAccelerator(javax.swing.KeyStroke.getKeyStroke(java.awt.event.KeyEvent.VK_F5, 0));
            ...
            .addGroup(layout.createSequentialGroup()
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGap(2, 2, 2)
                        .addComponent(jtfCodigoProduto, javax.swing.GroupLayout.PREFERRED_SIZE, 146, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addGap(34, 34, 34)
    ...
    private void jmiAlterarQuantidadeActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jmiAlterarQuantidadeActionPerformed
        ...
        if (linha >= 0) {
            ...
            if (viewQuantidadePDV.getReturnStatus() != 0) {
                quantidadeProduto = viewQuantidadePDV.getReturnStatus();
                adicionarProduto((int) tbProdutos.getValueAt(linha, 1));
    ...
    private void jmiFinalizarVendaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jmiFinalizarVendaActionPerformed
        int linha = tbProdutos.getRowCount();
        if (linha != 0) {
            this.jtfValorPagar.setText(String.valueOf(this.somaEAtualizaValorTotal()));
            ...
            JOptionPane.showMessageDialog(null, "É necessário selecionar ao menos um produto");
        }
    }//GEN-LAST:event_jmiFinalizarVendaActionPerformed

    private void jmiAdicionarProdutoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jmiAdicionarProdutoActionPerformed
        jTextFieldStatusCaixa.setText("Em operação");
        ...
        if (viewPesquisarProduto.getReturnStatus() != 0) {
            codigoProduto = viewPesquisarProduto.getReturnStatus();
            quantidadeProduto = viewPesquisarProduto.getReturnQuantidade();
            this.adicionarProduto(codigoProduto);
            this.jtfValorPagar.setText(String.valueOf(this.somaEAtualizaValorTotal()));
        }
    }//GEN-LAST:event_jmiAdicionarProdutoActionPerformed
    ...
    private void jtfQuantidadeKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_jtfQuantidadeKeyPressed
        if (evt.getKeyCode() == KeyEvent.VK_ENTER) {
            if (jtfQuantidade.getText().equals("")) {
                ...
                quantidadeProduto = Integer.valueOf(jtfQuantidade.getText());
                keyPressed(evt);
                this.jtfValorPagar.setText(String.valueOf(this.somaEAtualizaValorTotal()));
            }
        }
    ...
    public void keyPressed(java.awt.event.KeyEvent e) {
        if (e.getKeyCode() == java.awt.event.KeyEvent.VK_ENTER) {
            ...
            try {
                ...
                this.jtfQuantidade.setText(null);
    ...
    private void adicionarProduto(int pCodigoProduto) {
        ControllerProdutos controllerProdutos = new ControllerProdutos();
        ModelProdutos modelProdutos = new ModelProdutos();
        DefaultTableModel modelo = (DefaultTableModel) tbProdutos.getModel();
    ...
    private double somaEAtualizaValorTotal() {
        ...
        for (int i = 0; i < cont; i++) {
            ...
            quant = Integer.parseInt(String.valueOf(tbProdutos.getValueAt(i, 3)));
            aux = valor * quant;
            soma = soma + aux;
        }
        return soma;
    ...
    private javax.swing.JMenuItem jmiAdicionarProduto;
