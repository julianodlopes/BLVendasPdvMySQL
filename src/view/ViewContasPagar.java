...
public class ViewContasPagar extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        tbContasPagar.setAutoResizeMode(javax.swing.JTable.AUTO_RESIZE_ALL_COLUMNS);
        tbContasPagar.setSelectionMode(javax.swing.ListSelectionModel.SINGLE_SELECTION);
        ...
        tbContasPagas.setAutoResizeMode(javax.swing.JTable.AUTO_RESIZE_ALL_COLUMNS);
        tbContasPagas.setSelectionMode(javax.swing.ListSelectionModel.SINGLE_SELECTION);
    ...
    private void btAlterarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btAlterarActionPerformed
        if (testarSelecao() == true) {
            try {
                ...
                JOptionPane.showMessageDialog(this, "Error!", "ATENÇÃO", JOptionPane.WARNING_MESSAGE);
            }
        }
    ...
    private boolean testarSelecao() {
        int selecionada = tbContasPagar.getSelectedRow();
