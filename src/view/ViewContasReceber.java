...
public class ViewContasReceber extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jtfPesquisa2 = new util.VerificarCampo("Numeros/Letras",50);
        ...
        jtfPesquisa1 = new util.VerificarCampo("Numeros/Letras",50);
        ...
        jtfValor = new util.VerificarCampo("Numeros/Ponto",10);
        jLabel3 = new javax.swing.JLabel();
        jtfDescricao = new util.VerificarCampo("Numeros/Letras",50);
        ...
        tbContasReceber.setAutoResizeMode(javax.swing.JTable.AUTO_RESIZE_ALL_COLUMNS);
        tbContasReceber.setSelectionMode(javax.swing.ListSelectionModel.SINGLE_SELECTION);
        ...
        tbContasRecebidas.setAutoResizeMode(javax.swing.JTable.AUTO_RESIZE_ALL_COLUMNS);
        tbContasRecebidas.setSelectionMode(javax.swing.ListSelectionModel.SINGLE_SELECTION);
        ...
        jPanel2Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel2Layout.createSequentialGroup()
                        .addComponent(jtfPesquisa1, javax.swing.GroupLayout.PREFERRED_SIZE, 370, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addGap(6, 6, 6)
        ...
        jTabbedPane1.addTab("Cadastro de contas", jPanel1);
    ...
    private void btAlterarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btAlterarActionPerformed
        if (testarSelecao() == true) {
            try {
                ...
                JOptionPane.showMessageDialog(this, "Error", "ATENÇÂO", JOptionPane.WARNING_MESSAGE);
            }
        }
    ...
    private void JbSAlvarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_JbSAlvarActionPerformed
        if (jtfDescricao.getText().equals("") || jdData.getDate() == null
                || jdVencimento.getDate() == null || jdPagamento.getDate() == null
                || jtfValor.getText().equals("")) {
            JOptionPane.showMessageDialog(this, "Você deve preencher todos os campos corretamente", "ATENÇÂO", JOptionPane.WARNING_MESSAGE);
    ...
    private void jbReceberContaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jbReceberContaActionPerformed
        ...
        try {
            ...
            JOptionPane.showMessageDialog(this, "Você deve selecionar uma conta!", "ATENÇÃO", JOptionPane.WARNING_MESSAGE);
        }
    ...
    private void limparDados() {
        ...
        this.jtfPesquisa2.grabFocus();
        this.jtfCodigoConta.setText("Nova Conta");
    }

    private boolean testarSelecao() {
        int selecionada = tbContasReceber.getSelectedRow();
